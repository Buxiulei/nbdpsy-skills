...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
本版式的命门是**单行**：一屏一行 8-12 字，绝不折行、绝不缩字号。
所以这里有两道闸，缺一不可：
...
⛔ 闸门报红时的唯一正解是**改稿**（加逗号 / 拆句）。调小字号 = 废掉这个版式。
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
# ────────────────────────── 画幅档（加档＝加一条，不动规则） ──────────────────────────
# max_chars 两档默认 12——版式规则不是画幅参数。--max-line-chars 可调 8–14（书名场景 13）：
...
def main(argv=None):
    ...
    if fails:
        ...
        print("处置：在建议位置加逗号或把句子拆成两句，重跑 tts_gen --timed 后再来。\n"
              "⛔ 不要调小字号——字号是这个版式的身份，缩了就没有这个版式了。", file=sys.stderr)
        return 1
