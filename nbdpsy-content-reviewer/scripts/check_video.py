#!/usr/bin/env python3
"""审查 nbdpsy-text-to-video 工作目录的短视频成片：时长合规 + 字幕时间轴健全 + 成片完整。

工作目录约定（对齐 nbdpsy-text-to-video 产线真实命名）：
...
检查项：
  0. 若 workdir 含 shots.json（nbdpsy-text-to-video 产线 Task 8 产物），以其 shots 数组长度
