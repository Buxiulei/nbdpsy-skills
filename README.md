...
NBDpsy 心理科普内容创作的两个 Agent Skill，支持 **Claude Code** 与 **Codex** 一键安装。
...
> 这两个 skill 为 NBDpsy（咨询师全员北大硕博的纯线上华人心理咨询工作室）定制，绑定其品牌话术、心理科普合规红线（YMYL）与数据库结构。**他人使用需按自己项目改造** SKILL.md 里的品牌 / 数据库 / 发布相关部分。
